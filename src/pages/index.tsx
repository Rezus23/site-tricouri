...
export default function Home() {
  return (
    <>
      <Head>
        <title>Passion4Jerseys - Tricouri de Fotbal Premium</title>
      </Head>

      {/* ⚠️ FIX-UL PENTRU SCROLL:
          Folosim 'min-h-screen' și 'overflow-x-hidden' (doar pe orizontală).
          NU folosim 'h-screen' sau 'overflow-hidden' pe main.
      */}
      <main className="w-full min-h-screen bg-black overflow-x-hidden">
        
        {/* =========================================
            1. HERO SECTION (Partea cu Textul)
           ========================================= */}
        <section className="relative min-h-[85vh] flex items-center justify-center w-full border-b border-gray-900 overflow-hidden">
          
          {/* Imagine fundal HERO (opțional, sau doar glow-ul albastru) */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] md:w-[500px] md:h-[500px] bg-blue-600/20 rounded-full blur-[100px] pointer-events-none" />
          ...
          <div className="container mx-auto px-6 relative z-10 text-center pt-20">
            ...
            {/* 👇 TEXT PROMOȚIONAL (Actualizat cu 15% dacă asta dorești, sau poți lăsa 20%) */}
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 mb-10">
        ...
        {/* =========================================
            2. BANNER WIDE SECTION (Separată de Hero)
           ========================================= */}
        ...
        {/* =========================================
            3. SECȚIUNE CATEGORII
           ========================================= */}
        <section className="py-20 bg-black border-b border-gray-900 relative z-20">
        ...
        {/* =========================================
            4. SECȚIUNE FEEDBACK
           ========================================= */}
        <section className="py-24 bg-[#050505] relative w-full border-b border-gray-900 relative z-20">
            <div className="container mx-auto px-6">
        ...
        {/* =========================================
            5. SECȚIUNE GHID COMANDĂ CUSTOM
           ========================================= */}
        <section className="py-20 bg-black border-t border-gray-900 relative overflow-hidden relative z-20">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                <div className="mt-10">
                    <Link href="/shop?categorie=custom" className="inline-flex items-center gap-2 bg-white text-black px-10 py-4 rounded-full font-black uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all transform hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.2)]">
                        Precomandă
                    </Link>
      ...
      {/* =========================================
          6. FOOTER
         ========================================= */}
      <footer className="bg-black py-12 text-center text-gray-500 text-sm border-t border-gray-900 mt-auto w-full relative z-20">
